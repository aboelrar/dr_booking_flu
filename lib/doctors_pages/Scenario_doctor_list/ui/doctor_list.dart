...
class doctor_list extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (flag == 0) {
      ...
      //SET COLOR ONLY FOR FIRST TIME
      if(flag_dialog == 1)
      {
        doctors_method_api.set_RateColors();
      ...
      print('noooooooofuck');
      doctor_method =
          Api_Call().get_my_appoienments("1"); //GET ALL MY APPOIENMENTS
      doctors_method_api.set_method(doctor_method); //SAVE DATA TO PROVIDER
    }
  ...
  Widget is_search(var flag,BuildContext context)
  {
    if (flag == 1)
    {
